<!-- ########## START: LEFT PANEL ########## -->
<div class="sl-logo"><a href="{{ route('admin.index')  }}"><i class="icon ion-android-star-outline"></i> Pro-Shop</a></div>
<div class="sl-sideleft">
    <div class="sl-sideleft-menu">
        <a href="{{ route('admin.index') }}" class="sl-menu-link  {{ Route::currentRouteName() == 'admin.index' ? 'active' : '' }} ">
        ...
        <ul class="sl-menu-sub nav flex-column">
            ...
            <li class="nav-item"><a href="{{ route('admin.brand.index')  }}" class="nav-link">Brand</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
            <div class="sl-menu-item">
        ...
        <a href="#" class="sl-menu-link">
            <div class="sl-menu-item">
                ...
                <span class="menu-item-label">Newslater</span>
                <i class="menu-item-arrow fa fa-angle-down"></i>
            </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
            <li class="nav-item"><a href="{{ route('admin.newslater.index')  }}" class="nav-link">Newslater</a></li>
        </ul>
        <a href="#" class="sl-menu-link">
            <div class="sl-menu-item">
