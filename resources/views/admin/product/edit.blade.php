                        ...
                        <div class="row mg-b-25">
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" value="{{ $product->name }}" placeholder="Enter product name">
                                    @error('name')
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('code') is-invalid @enderror" type="text" name="code" value="{{ $product->code  }}" placeholder="Enter product code">
                                    @error('code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('quantity') is-invalid @enderror" type="number" name="quantity" value="{{ $product->quantity  }}" placeholder="Enter product quantity">
                                    @error('quantity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('color') is-invalid @enderror" type="text" name="color" value="{{ $product->color  }}" placeholder="Enter product color" data-role="tagsinput">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('size') is-invalid @enderror" type="text" name="size" value="{{ $product->size  }}" placeholder="Enter product size" data-role="tagsinput">
                                    @error('size')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('price') is-invalid @enderror" type="number" name="price" value="{{ $product->price  }}" placeholder="Enter product price">
                                    @error('price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('sell_price') is-invalid @enderror" type="number" name="sell_price" value="{{ $product->sell_price  }}" placeholder="Enter product sell price">
                                    @error('sell_price')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('discount_price') is-invalid @enderror" type="number" name="discount_price" value="{{ $product->discount_price  }}" placeholder="Enter product discount price">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('video') is-invalid @enderror" type="text" name="video" value="{{ $product->video  }}" placeholder="Enter video link">
                                    @error('video')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img src="{{ asset($product->image_one)  }}" id="upload_image_one"  alt="" width="100" height="70">
                            ...
                            <div class="col-lg-3 mg-t-40 mg-lg-t-0">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <br>
                                    <img src="{{ asset( $product->image_two) }}" id="upload_image_two"  alt="" width="100" height="70">
                                </div>
                            </div><!-- col -->
                            <div class="col-lg-3 mg-t-40 mg-lg-t-0">
                                <div class="form-group">
                                    ...
                                    @enderror
                                    <br>
                                    <img src="{{ asset( $product->image_three)  }}" id="upload_image_three"  alt="" width="100" height="70">
                                </div>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label class="ckbox">
                                        <input type="checkbox" name="hot_deal"  value="1"  @if($product->main_slider == 1) checked @endif>
                                        <span>Hot Deal</span>
                                    </label>
                                    @error('hot_deal')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-lg-2">
                                <div class="form-group">
                                    <label class="ckbox">
                                        <input type="checkbox" name="best_rated"  value="1"  @if($product->main_slider == 1) checked @endif>
