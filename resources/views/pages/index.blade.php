@extends('layouts.app')
@section('header')
    @include('partial._mainnav')
    @include('partial._pagemenu')
@endsection
@section('content')
                    ...
                    <div class="deals_slider_container">
                        ...
                        <div class="owl-carousel owl-theme deals_slider">
                            ...
                            @foreach($hotDealProducts as $product)
                                ...
                                <div class="deals_image"><img src="{{ asset($product->image_one)  }}" alt="{{ $product->name  }}"></div>
                                <div class="deals_content">
                                    @if($product->discount_price == null)
                                            <div class="deals_info_line d-flex flex-row justify-content-start">
                                                <div class="deals_item_category"><a href="#">{{ $product->brand->name  }}</a></div>
                                                <div class="deals_item_price_a ml-auto">{{ $product->sell_price  }}</div>
                                            </div>
                                            <div class="deals_info_line d-flex flex-row justify-content-start">
                            ...
                            <div class="featured_slider slider">
                                ...
                                @foreach($featuredProducts as $product)
                                    ...
                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img width="100" height="auto" src="{{ asset($product->image_one)  }}" alt="{{ $product->name  }}"></div>
                                        <div class="product_content">
                                            <div class="product_price discount">
                                                @if($product->discount_price == null)
                                                    ${{ $product->sell_price  }}
                                                @else
                                                    ${{ $product->discount_price  }}<span>${{ $product->sell_price  }}</span>
                                                @endif
                                            </div>
                                        ...
                                        <ul class="product_marks">
                                            ...
                                            @else
                                                @php
                                                    ...
                                                    $percentage = (100 * $discount) / $product->sell_price ;
                                                @endphp
                                                <li class="product_mark product_discount">{{ round($percentage) }}%</li>
                                            @endif
                                        </ul>
                                    </div>
...
<div class="banner_2">
    ...
    <div class="banner_2_container">
        ...
        <div class="owl-carousel owl-theme banner_2_slider">
            @foreach($midSliderProducts as $product)
                            ...
                            <div class="row fill_height">
                                <div class="col-lg-4 col-md-6 fill_height">
                                    <div class="banner_2_content">
                                        <div class="banner_2_category">{{ $product->brand->name  }}</div>
                                        <div class="banner_2_title">{{ $product->name  }}
                                            <br>
                                            @if($product->discount_price == null)
                                                ${{ $product->sell_price  }}
                                            @else
                                                ${{ $product->discount_price  }}<span style="margin-left: 10px;text-decoration: line-through;color: red;">${{ $product->sell_price  }}</span>
                                            @endif
                                        </div>
                                ...
                                <div class="col-lg-8 col-md-6 fill_height">
                                    <div class="banner_2_image_container">
                                        <div class="banner_2_image"><img src="{{ asset($product->image_one)  }}" alt="{{ $product->name  }}"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="newsletter_container d-flex flex-lg-row flex-column align-items-lg-center align-items-center justify-content-lg-start justify-content-center">
                    ...
                    <div class="newsletter_content clearfix">
                        <form action="{{ route('newslater.store')  }}" class="newsletter_form" method="POST">
                            @csrf
                            <input type="text" class="newsletter_input @error('email') is-invalid @enderror" placeholder="Enter your email address" name="email" />
                            @error('email')
